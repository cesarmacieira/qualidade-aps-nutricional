...
DadosICSAP_Capitais = DadosICSAP %>%
  ...
  mutate(TaxaICSAP = TaxaICSAP*10000, TaxaANEMIA = TaxaANEMIA*10000,
         TaxaDEFICIENCIAS_NUTRICIONAIS = TaxaDEFICIENCIAS_NUTRICIONAIS*10000,
         TaxaDIABETES_MELITUS = TaxaDIABETES_MELITUS*10000,
         TaxaHIPERTENSAO = TaxaHIPERTENSAO*10000)
